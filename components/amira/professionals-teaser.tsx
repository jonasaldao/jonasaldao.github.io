  ...
  return (
    ...
    >
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div
            className="aurora absolute -top-32 -right-16 w-[28rem] h-[28rem] rounded-full bg-teal/25 blur-[100px] pointer-events-none"
            aria-hidden="true"
          />

          <div className="relative flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-14">
            <div className="max-w-xl">
              <span className="inline-block bg-white/10 text-teal-light font-semibold text-xs uppercase tracking-widest px-4 py-2 rounded-full ring-1 ring-white/15">
            ...
            <div className="lg:ml-auto shrink-0">
              <Button
                ...
                size="lg"
                data-magnetic
                className="bg-white hover:bg-teal-light text-teal-dark rounded-full px-8 py-7 text-base font-semibold shadow-xl shadow-ink/30 transition-colors duration-300"
              >
