...
export function FinalCTA() {
  return (
    <section className="relative py-28 md:py-40 overflow-hidden bg-gradient-to-br from-verde-profundo via-verde to-verde-profundo grain">
      {/* Aurora blobs */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-white/75 text-sm">
          <span className="flex items-center gap-2">
            <Check size={16} className="text-menta" />
