...
export const metadata: Metadata = {
  title: "Términos de uso para usuarios — Amira",
  description:
    "Condiciones de uso de Amira para personas usuarias: qué es y qué no es la plataforma, quién puede usarla y cómo funciona el directorio de profesionales.",
  alternates: { canonical: "/terminos/usuarios" },
  ...
  return (
    ...
    >
      ...
      <LegalSection n="05" title="Acceso durante la beta">
        ...
        <p>
          Registrarte en la lista de espera de la beta no crea una cuenta, no
          garantiza tu participación y no implica acceso inmediato a la
          plataforma. Solo registra tu interés para una futura invitación.
        </p>
        <p className="font-medium text-navy">
